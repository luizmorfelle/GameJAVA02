...
public class Entity {
	...
	public static BufferedImage BIG_COIN = Game.spritesheet.getSprite(0, 16, 16, 16);
	public static BufferedImage ENEMY = Game.spritesheet.getSprite(8*16, 0, 16, 16);
	public static BufferedImage GHOST_ENEMY = Game.spritesheet.getSprite(8*16, 16, 16, 16);
